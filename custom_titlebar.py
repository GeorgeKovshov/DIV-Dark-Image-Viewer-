...
"""
minimized = False  # only to know if root is minimized
maximized = False  # only to know if root is maximized
...
def maximize_me(root):
    global maximized
    if maximized == False:  # if the window was not maximized
...
expand_button = Button(title_bar, text=' 2 ', command=maximize_me, bg=RGRAY, padx=2, pady=2, bd=0, fg='white',
                       font=("calibri", 13), highlightthickness=0)
minimize_button = Button(title_bar, text=' 1 ', command=minimize_me, bg=RGRAY, padx=2, pady=2, bd=0, fg='white',
                         font=("calibri", 13), highlightthickness=0)
...
def get_pos(event, root, title_bar):  # this is executed when the title bar is clicked to move the window
    global maximized
    if maximized == False:
